...
- `GET /api/panel/car-options` - справочники категорий, городов, марок и цветов
...
- Таблицы `car_categories`, `car_cities`, `car_brands`, `car_colors` используются как общие справочники для сайта, ЛК и админки
