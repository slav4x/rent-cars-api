...
import {
    ...
    findLatestVerificationRequestByUserId,
    findVerificationFilesByRequestId,
...
const requiredFileTypes: VerificationFileRecord["type"][] = [
    "passport_main",
    "passport_registration",
    "license_front",
    "license_back",
...
async function updateUserActivity(
    ...
    await updateUserRecord({
        ...
        lastBookingAt:
            updates.lastBookingAt === undefined
                ? user.lastBookingAt
                : updates.lastBookingAt,
        lastLoginAt:
            updates.lastLoginAt === undefined ? user.lastLoginAt : updates.lastLoginAt,
    });
}
...
function savePrivateVerificationFile(params: {
    ...
    documentType: VerificationFileRecord["type"];
    body: Buffer;
    mimeType: string;
    originalName: string;
...
function getVerificationExtension(mimeType: string, originalName: string) {
